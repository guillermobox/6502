...
class Adapter():
    ...
    def get_a(self):
        return cpu6502.get_a()
    def set_a(self, value):
        return cpu6502.set_a(value)

    def get_sp(self):
        return cpu6502.get_sp()
    def set_sp(self, value):
        return cpu6502.set_sp(value)

    def get_pc(self):
        return cpu6502.get_pc()
    def set_pc(self, addr):
        return cpu6502.set_pc(addr)


    def get_x(self):
        return cpu6502.get_x()
    def set_x(self, value):
        return cpu6502.set_x(value)

    def get_y(self):
        return cpu6502.get_y()
    def set_y(self, value):
        return cpu6502.set_y(value)

    def get_p(self):
        return cpu6502.get_p()
    def set_p(self, value):
        return cpu6502.set_p(value)
...
#        self.assertEqual(mpu.UNUSED, mpu.p & mpu.UNUSED)
    ...
    def _write(self, memory, start_address, bytes):
        for offset, byte in enumerate(bytes):
            cpu6502.write(start_address + offset, byte)
